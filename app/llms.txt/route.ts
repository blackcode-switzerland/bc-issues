...
function buildLlmsTxt(): string {
  return [
    ...
    `> ${m.summary}`,
    '',
    'This site is fully usable programmatically — authenticate with a bearer token and call the HTTP API, or drive the bk CLI. Humans use the web UI at /dashboard.',
    '',
    '## Programmatic access',
